...
def load_env(env_file=None):
    """Simple .env loader — works without python-decouple."""
...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-change-me-in-production-xyz123abc')
...
DATABASES = {
    'default': {
        ...
        'NAME': env('DB_NAME', default='localservice_db'),
